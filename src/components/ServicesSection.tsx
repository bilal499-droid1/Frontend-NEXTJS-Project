        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Use natural prompts to automatically label images with Gemini 2.5.
              Reduce hours of manual effort in seconds.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Use our modern annotation canvas (Konva.js) to draw bounding boxes
              or future polygon tools with ease.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Export your labeled datasets in popular formats like YOLO TXT and
              COCO JSON, ready for training ML models.
            </p>
          </div>
        </div>
      </div>
