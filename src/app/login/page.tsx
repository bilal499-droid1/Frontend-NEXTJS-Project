        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-white/70 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent text-gray-700"
              required
            />
          </div>
