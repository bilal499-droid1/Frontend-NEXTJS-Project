        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Type &quot;find all safety helmets&quot; and watch the system
              detect and label all objects instantly.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Transparent usage with AI credits. Only pay for what you use
              &mdash; top up anytime.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              We use React + UI virtualization to ensure smooth scrolling even
              for 10,000+ images.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              User-friendly experience that makes annotation simple and fast for
              every skill level.
            </p>
          </div>
        </div>
