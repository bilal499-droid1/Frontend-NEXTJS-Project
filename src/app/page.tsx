...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      {/* Top-left curved design element */}
      <div
        ...
        style={{
          ...
          background:
            "linear-gradient(135deg, rgba(237, 233, 254, 1) 0%, rgba(245, 243, 255, 0.8) 100%)",
        }}
      ></div>
      {/* Additional top-left design accent */}
      <div
        className="absolute -z-10"
        style={{
          top: "0",
          ...
          background:
            "linear-gradient(135deg, rgba(121, 86, 223, 0.2) 0%, rgba(121, 86, 223, 0) 100%)",
        }}
      ></div>
      ...
      <div
        ...
        style={{
          ...
          height: "50%",
          background:
            "radial-gradient(circle, rgba(121, 86, 223, 0.15) 0%, rgba(255, 255, 255, 0) 70%)",
        }}
      ></div>
      <div
        className="absolute -z-10"
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-transparent py-12 px-6 md:px-10 lg:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="z-10">
            ...
            <p className="text-xl mb-3 font-bold text-gray-900">
              Smartest Datasets{" "}
              <span
                style={{ color: "#7956DF", fontWeight: 900 }}
              ...
              <div className="relative w-full h-72 sm:h-80 md:h-96">
                <div className="absolute inset-0 flex items-center justify-center bg-indigo-50/70 rounded-lg p-4">
                  <div className="text-center">
                    <div
                      className="w-20 h-20 mx-auto bg-purple-600 rounded-full flex items-center justify-center mb-4"
                      style={{ backgroundColor: "#7956DF" }}
                    >
                      <svg
                    ...
                    <p className="text-gray-600 mt-2">
                      Label, annotate, and generate data with our platform
                    </p>
                  </div>
                </div>
              </div>
