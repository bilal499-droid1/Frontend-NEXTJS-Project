    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="px-6 py-4 md:px-10 lg:px-20 flex justify-between items-center border-b border-gray-100">
        ...
        <div className="flex items-center space-x-2">
          <div className="w-8 h-8 rounded-md flex items-center justify-center" style={{ background: '#7956DF' }}>
            <span className="text-white font-bold text-sm">CV</span>
          </div>
          <span className="text-gray-900 font-bold">Computer <span style={{ color: '#7956DF' }}>Vision</span></span>
        </div>
        ...
        <div className="hidden md:flex space-x-10 text-sm">
          ...
          <Link href="/docs" className="text-gray-700 hover:text-indigo-600 transition-colors">
            Docs
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="z-10">
            ...
            <p className="text-xl mb-3">
              Smarter Datasets <span style={{ color: '#7956DF' }} className="font-semibold">Start Here</span>
            </p>
          ...
          <div className="relative z-10">
            <div className="rounded-lg overflow-hidden shadow-2xl border border-gray-100">
              <img 
                ...
                onError={(e) => {
                  e.currentTarget.src = 'https://via.placeholder.com/600x400?text=Computer+Vision';
                }}
              />
            </div>
          </div>
