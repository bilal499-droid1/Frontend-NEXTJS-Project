...
export default function PricingContent() {
  return (
    <section id="pricing" className="py-20 px-6 md:px-10 lg:px-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-bold" style={{ color: '#7956DF' }}>
            Stage of Growth.
          </h3>
        </div>
        ...
        <div className="relative max-w-xs mx-auto md:mx-0 md:ml-auto md:mr-16 mb-16">
          ...
          >
            <p className="text-center">
              <span className="text-black font-extrabold">Pay Only for What</span> <br />
              <span style={{ color: '#7956DF' }} className="font-black text-lg">You Use</span>
            </p>
            {/* Speech bubble tail */}
